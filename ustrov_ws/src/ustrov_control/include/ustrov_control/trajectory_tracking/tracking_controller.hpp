...
#include "ustrov_control/trajectory_tracking/tracking_control.hpp"
...
class TrackingControllerNode : public rclcpp::Node {
 ...
 private:
  ...
  void OnPositionTarget(
    ...
    ustrov_common::convert::RosToEigen(_msg->point, position_target_);
  }
  ...
  void OnVelocityTarget(
    ...
    ustrov_common::convert::RosToEigen(_msg->vector, velocity_target_);
  }

  OnSetParametersCallbackHandle::SharedPtr params_cb_handle_{nullptr};

  rclcpp::Publisher<ustrov_control_msgs::msg::AttitudeTarget>::SharedPtr
