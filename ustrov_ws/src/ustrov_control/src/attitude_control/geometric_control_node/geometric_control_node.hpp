...
#include <ustrov_control_msgs/msg/roll_target.hpp>
...
class GeometricControlNode : public rclcpp::Node {
 ...
 private:
  ...
  ustrov_control_msgs::msg::ActuatorSetpoint ZeroMsg(
  ...
  void OnRollTarget(const ustrov_control_msgs::msg::RollTarget::SharedPtr msg) {
  ...
  rclcpp::Subscription<geometry_msgs::msg::Vector3Stamped>::SharedPtr
      heading_target_sub_;
  rclcpp::Subscription<ustrov_control_msgs::msg::RollTarget>::SharedPtr
      roll_target_sub_;
