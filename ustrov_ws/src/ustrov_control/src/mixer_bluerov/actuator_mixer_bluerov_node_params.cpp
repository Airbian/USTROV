...
void ActuatorMixerNode::DeclareParams() {
  ...
  double alpha_f = declare_parameter<double>(
      name,
      ustrov_common::param_utils::Description("Thruster angle front", true));
  name = "geometry.alpha_r";
  double alpha_r = declare_parameter<double>(
      name,
      ustrov_common::param_utils::Description("Thruster angle rear", true));
  name = "geometry.l_hf";
  double l_hf = declare_parameter<double>(
      name, ustrov_common::param_utils::Description(
  ...
  name = "geometry.l_vx";
  double l_vx =
      declare_parameter<double>(name, ustrov_common::param_utils::Description(
  ...
  auto limit_matrix = declare_parameter<std::vector<double>>(
      name, ustrov_common::param_utils::Description("Input Limits", true));
  matrix_size =
      mixer_bluerov::kOutputChannels * mixer_bluerov::InputChannels::kCount;
  ...
  param = ustrov_common::param_utils::Description(descr);
