...
void ControlNode::InitPublishers() {
  ...
  using ustrov_control_msgs::msg::ActuatorControls;
  actuator_controls_pub_ = create_publisher<ActuatorControls>(topic, qos);

  topic = "~/mode";
  using ustrov_control_msgs::msg::FailureControlModeStamped;
  mode_pub_ = create_publisher<FailureControlModeStamped>(topic, qos);

  topic = "~/debug";
  using ustrov_control_msgs::msg::FailureControlDebug;
...
void ControlNode::PublishDebugMsg(const rclcpp::Time &_now,
  ...
  ustrov_control_msgs::msg::FailureControlDebug msg;
...
void ControlNode::PublishMode(const rclcpp::Time &_now, mode::Mode _mode) {
  ustrov_control_msgs::msg::FailureControlModeStamped msg;
  msg.header.stamp = _now;
  msg.mode.mode = _mode;
...
RCLCPP_COMPONENTS_REGISTER_NODE(ustrov_control::motor_failure::ControlNode)
