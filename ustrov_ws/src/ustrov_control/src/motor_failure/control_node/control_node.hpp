...
#include <ustrov_control/motor_failure/motor_failure.hpp>
#include <ustrov_control/thruster_model.hpp>
#include <ustrov_control_msgs/msg/actuator_controls.hpp>
#include <ustrov_control_msgs/msg/actuator_setpoint.hpp>
#include <ustrov_control_msgs/msg/failure_control_debug.hpp>
#include <ustrov_control_msgs/msg/failure_control_mode_stamped.hpp>
...
class ControlNode : public rclcpp::Node {
 ...
 private:
  ...
  void OnThrustSetpoint(
      const ustrov_control_msgs::msg::ActuatorSetpoint::SharedPtr);
  ...
  // Publishers
  //////////////////////////////////////////////////////////////////////////////
  rclcpp::Publisher<ustrov_control_msgs::msg::ActuatorControls>::SharedPtr
      actuator_controls_pub_;
  rclcpp::Publisher<ustrov_control_msgs::msg::FailureControlDebug>::SharedPtr
      debug_pub_;
  rclcpp::Publisher<
      ustrov_control_msgs::msg::FailureControlModeStamped>::SharedPtr mode_pub_;
  //////////////////////////////////////////////////////////////////////////////
  // Subscriptions
  //////////////////////////////////////////////////////////////////////////////
  rclcpp::Subscription<ustrov_control_msgs::msg::ActuatorSetpoint>::SharedPtr
      thrust_sub_;
  ...
  ustrov_control::ThrusterModel thruster_model_;
