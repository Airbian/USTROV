...
RateControlNode::RateControlNode(rclcpp::NodeOptions const &_options)
  ...
  rates_debug_pub_ = create_publisher<ustrov_control_msgs::msg::RatesDebug>(
...
void RateControlNode::PublishTorqueOutput(const rclcpp::Time &_now,
  ...
  ustrov_common::convert::EigenToRos(_torque, msg);
...
void RateControlNode::OnOdometry(
  ...
  ustrov_common::convert::RosToEigen(_msg->twist.twist.angular,
                                    angular_velocity);
  ...
  ustrov_control_msgs::msg::RatesDebug debug_msg;
  debug_msg.header.stamp = _msg->header.stamp;
  ustrov_common::convert::EigenToRos(body_rates_setpoint_,
                                    debug_msg.rates_desired);
  ustrov_common::convert::EigenToRos(angular_velocity, debug_msg.rates);
...
void RateControlNode::OnAngularVelocitySetpoint(
  ...
  ustrov_common::convert::RosToEigen(_msg->vector, body_rates_setpoint_);
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(ustrov_control::rate_control::RateControlNode)
