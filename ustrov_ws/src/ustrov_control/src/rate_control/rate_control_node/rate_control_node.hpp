...
#include <ustrov_control/rate_control/rate_controller.hpp>
#include <ustrov_control_msgs/msg/actuator_setpoint.hpp>
#include <ustrov_control_msgs/msg/rates_debug.hpp>
#include <ustrov_control_msgs/msg/rates_target.hpp>
...
class RateControlNode : public rclcpp::Node {
 ...
 private:
  ...
  rclcpp::Publisher<ustrov_control_msgs::msg::ActuatorSetpoint>::SharedPtr
      torque_pub_;
  rclcpp::Publisher<ustrov_control_msgs::msg::RatesDebug>::SharedPtr
      rates_debug_pub_;
  ...
  ustrov_control::rate_control::RateController controller_;
