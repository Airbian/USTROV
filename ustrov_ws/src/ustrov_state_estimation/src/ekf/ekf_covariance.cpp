...
void Ekf::FixCovarianceErrors(bool force_symmetry) {
  ...
  if (!accel_bias_inhibited_[0] || !accel_bias_inhibited_[1] ||
    ...
    for (int state_index = dv_bias_start; state_index <= dv_bias_end;
         ++state_index) {
...
void Ekf::PredictCovariance() {
  ...
  StateMatrixd process_noise_var = StateMatrixd::Zero();
  ...
  for (int i = 10; i < 13; ++i) {
    ...
    P_new(i, i) = KahanSummation(P_new(i, i), process_noise_var(i, i),
  ...
  if (!accel_bias_inhibited_[0]) {
    ...
    P_new(13, 13) = KahanSummation(P_new(13, 13), process_noise_var(13, 13),
  ...
  if (!accel_bias_inhibited_[1]) {
    ...
    P_new(14, 14) = KahanSummation(P_new(14, 14), process_noise_var(14, 14),
  ...
  if (!accel_bias_inhibited_[2]) {
    ...
    P_new(15, 15) = KahanSummation(P_new(15, 15), process_noise_var(15, 15),
